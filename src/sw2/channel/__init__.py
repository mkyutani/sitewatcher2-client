...
from sw2.channel.command_refresh import sw2_channel_refresh, sw2_parser_channel_refresh
...
channel_function_map = {
    ...
    'refresh': { 'function': sw2_channel_refresh, 'parser': sw2_parser_channel_refresh },
