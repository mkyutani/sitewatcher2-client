...
from sw2.site.command_list_resources import sw2_parser_site_resources, sw2_site_resources
from sw2.site.command_set import sw2_parser_site_set, sw2_site_set
from sw2.site.command_test_resources import sw2_parser_site_test, sw2_site_test
from sw2.site.command_update_resources import sw2_parser_site_update, sw2_site_update
...
site_function_map = {
    ...
    'list-resources': { 'function': sw2_site_resources, 'parser': sw2_parser_site_resources },
    'set': { 'function': sw2_site_set, 'parser': sw2_parser_site_set },
    'test-resources': { 'function': sw2_site_test, 'parser': sw2_parser_site_test },
    'unset': { 'function': sw2_site_unset, 'parser': sw2_parser_site_unset },
    'update-resources': { 'function': sw2_site_update, 'parser': sw2_parser_site_update },
