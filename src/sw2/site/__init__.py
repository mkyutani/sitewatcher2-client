...
from sw2.site.set import sw2_parser_site_set, sw2_site_set
from sw2.site.unset import sw2_parser_site_unset, sw2_site_unset
from sw2.site.variables import sw2_parser_site_variables, sw2_site_variables
